...
export const SearchItem: React.FC<SearchItemProps> = ({text, onClick}) => {
    return (
        <div onClick={onClick} className="hover:cursor-pointer hover:brightness-90 mb-2 flex flex-row group w-fit mx-1 justify-center justify-start text-sm bg-bg2 text-white font-bold py-1 ps-3 pe-2 rounded-full group-hover:brightness-90">
